...
#SBATCH --array=0-124%31   # 90 tasks total, max 30 running at once
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=06:00:00
#SBATCH --mail-user=bwaits@byu.edu 
...
signals=("barra_rev")
DATASET="/home/bwaits/Research/sf-research-reversal/research/experiments/alphas/barra_rev.parquet"
...
year_ends=(
  ...
  "2021-06-26" "2022-06-26" "2023-06-26" "2024-06-26" "2025-06-26"
  "2025-11-12"
)
...
srun python research/experiments/experiment_3b.py "$DATASET" "$signal" "$start" "$end" --write